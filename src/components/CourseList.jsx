...
const courseList = () => {
  ...
  return (
    <div className='relative w-full h-[110vh] mt-20 bg-[var(--fourth-color)]'>
       {courseDetail!=-1 && <CourseDetails i={courseDetail} setCourseDetail={setCourseDetail}/>}
      <MaxWidthWrapper className='w-full h-full flex justify-between'>
        <div className='my-12 w-1/5 h-4/5 flex flex-col justify-between hover:scale-110 transition-transform duration-300 bg-white rounded-lg'>
            <div className='h-[35%] w-full bg-[var(--primary-color)] flex justify-center'>
                <img src="intermediate.png" className='bg-[var(--primary-color)] h-full' alt="" />
            </div>
        ...
        <div className='my-12 w-1/5 h-4/5 flex flex-col justify-between hover:scale-110 transition-transform duration-300 bg-white rounded-lg'>
            <div className='h-[35%] w-full bg-[var(--primary-color)] flex justify-center'>
                <img src="advanced.png" className='bg-[var(--primary-color)] h-4/5' alt="" />
            </div>
            <div className='w-full h-[40%] flex flex-col items-center text-black custom-bullet'>
            <div className='font-MerriWeatherBold'>Chess for Intermediate</div>
            <ul className='list-disc list-inside pl-4'>
        ...
        <div className='my-12 w-1/5 h-4/5 flex flex-col justify-between hover:scale-110 transition-transform duration-300 bg-white rounded-lg'>
            <div className='h-[35%] w-full bg-[var(--primary-color)] flex justify-center'>
                <img src="gm.png" className='bg-[var(--primary-color)] h-4/5' alt="" />
            </div>
            <div className='w-full h-[40%] flex flex-col items-center text-black custom-bullet'>
        ...
        <div className='my-12 w-1/5 h-4/5 flex flex-col justify-between hover:scale-110 transition-transform duration-300 bg-white rounded-lg'>
            <div className='h-[35%] w-full bg-[var(--primary-color)] flex justify-center'>
                <img src="beginner.png" className='bg-[var(--primary-color)] h-4/5' alt="" />
            </div>
            <div className='w-full h-[40%] flex flex-col items-center text-black custom-bullet'>
